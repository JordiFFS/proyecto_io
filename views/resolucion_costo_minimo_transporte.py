...
def mostrar_resolucion_costo_minimo_transporte(costos, oferta, demanda):
    """
...
def ejemplo_costo_minimo_transporte():
    ...
    st.subheader("Ejemplo: Método de Costo Mínimo")
    st.write("""
    **Problema:** Distribuir mercancía desde 3 orígenes a 4 destinos minimizando el costo inicial.

    **Oferta:** O1=100, O2=150, O3=120
    **Demanda:** D1=80, D2=70, D3=90, D4=60
    """)

    if st.button("Ejecutar Ejemplo", key="ej_costo_minimo_transp_example"):
        costos = [
            [4, 6, 8, 6],
            [5, 4, 7, 5],
            [6, 5, 4, 6]
